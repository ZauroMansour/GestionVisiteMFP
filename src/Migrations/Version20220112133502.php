 ...
 */
final class Version20220112133502 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agent_etat ADD cniname VARCHAR(255) DEFAULT NULL, ADD reponse LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agent_etat DROP cniname, DROP reponse');
