 ...
 */
final class Version20211103121751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE visite CHANGE genre genre VARCHAR(50) NOT NULL, CHANGE ministere_id ministere_id INT NOT NULL, CHANGE thematique_id thematique_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE visite CHANGE ministere_id ministere_id INT DEFAULT NULL, CHANGE thematique_id thematique_id INT DEFAULT NULL, CHANGE genre genre VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
