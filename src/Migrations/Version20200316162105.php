 ...
 */
final class Version20200316162105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE motif_demande (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE visite (id INT AUTO_INCREMENT NOT NULL, nom_visiteur VARCHAR(100) NOT NULL, prenom_visiteur VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, date_visite DATETIME NOT NULL, demande LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE motif_demande');
